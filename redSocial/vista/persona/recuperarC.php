        ...
        <div class="col-xs-6 col-sm-6" class="container">
            <div class="container" id="formulario">
                ...
                <form class="contact_form" action="#" id="contact_form" runat="server">
                    <label for="recuUsuario">Usuario</label>
                    <input id="recuUsuario" type="text" class="form-control" required>
                    <br>
                    <label for="recuEmail">Email</label>
                    <input id="recuEmail" type="email" class="form-control" required>
                    <br>
                    <label for="recuNueva">Nueva Contraseña</label>
                    <input id="recuNueva" type="password" class="form-control" required>
                    ...
                    <div style="text-align: right;">
                        <button type="submit" id="actualizarRc" class=" actualizarRc btn btn-dark">Actualizar</button>
                    </div>
                </form>
